...
path_editor_coverphoto_info = Eine Url, die für das Coverfoto verwendet werden soll. Das Foto muss an anderer Stelle hochgeladen werden. Zum Beispiel auf der Volt Europa Website.
...
path_editor_item_choose_type_value_headline = Überschrift 2
