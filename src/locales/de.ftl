...
block_tree_own_blocks = Deine Seiten
...
needs_login_block_type_new_person = Für eine neue Person anmelden…
needs_login_block_type_new_button = Für einen neuen Button anmelden…
needs_login_block_type_new_text = Für einen neuen Text anmelden…
needs_login_block_type_new_code = Für einen neuen Code anmelden…
...
placeholder_headline_empty = Ohne Titel
...
list_title = Liste
sort_label_properties_text = Name / Titel
