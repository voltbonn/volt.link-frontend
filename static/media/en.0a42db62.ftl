...
recent_description = The last 5 pages you edited will appear here.
...
needs_login_block_type_new_person = Login to create a new Person…
needs_login_block_type_new_button = Login to create a new Button…
needs_login_block_type_new_text = Login to create a new Text…
needs_login_block_type_new_code = Login to create a new Code…
...
list_title = List
sort_label_properties_text = Name / Title
