...
path_editor_main_contact_label = Main contact for this link:
path_editor_main_contact_info = (Only used internally. This won't be published.)
...
path_editor_coverphoto_info = A url to use for the coverphoto. The photo needs to be uploaded somewhere else. For example on the Volt Europa website.
