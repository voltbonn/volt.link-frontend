...
permissions_dialog_title = Give viewing and editing rights
permissions_dialog_description = Enter @volteuropa.org addresses to give editing rights.<br/>Google-Groups addresses are not supported.
